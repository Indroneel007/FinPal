...
migrateup:
	migrate -source file://db/migration -database "postgres://postgres:kanikaindro@db.vybiuledkxidxrtdxday.supabase.co:5432/postgres" -verbose up

migratedown:
	migrate -source file://db/migration -database "postgres://postgres:kanikaindro@db.vybiuledkxidxrtdxday.supabase.co:5432/postgres" -verbose down
